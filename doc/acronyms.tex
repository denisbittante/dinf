...
{
  name=OSRE,
  description={Open Source Reporting Engine, Framekwork für das verarbeiten und erstellen von Reports}
}
...
\newglossaryentry{ram}{
name=RAM, 
description={Random-Access Memory bezeichnet das Arbeitsspeicher bei Computer}
}
