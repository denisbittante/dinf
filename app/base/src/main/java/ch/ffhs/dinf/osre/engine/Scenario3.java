...
public interface Scenario3 {

	final static String AUTHOR = "TEST Author";
	final static String FILENAME = "SZENARIO 3 TEST";
	final static String SUBJECT = "Subject of Scenario 3";
	final static String KEYWORDS = "szenario3, pdf-test, loadtest";
